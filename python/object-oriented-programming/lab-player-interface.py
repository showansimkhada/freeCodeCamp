...
Passed: 25. The Pawn's level_up method should add the four diagonal movement of 1 unit to the moves attribute.
...
class Player(ABC):
    ...
    def make_move(self):
        rand = random.choice(self.moves)
        new_pos = (rand[0] + self.position[0], rand[1] + self.position[1])
